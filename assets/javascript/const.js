...
var nyc = [
    ["all", iHome, iSecurity,"In - home shelter", "<h2 class = 'pan'>In-Home Shelter</h2><br>When warned of an emergency situation reaching your home, fill your bathtub with water.  Having a <a href = '#'>clean, waterproof liner</a> stored under the bathroom sink will help ensure that the water will not leak, and you also will not have to scrub the tub before filling it."],
    ...
    ["all", iWater, iCar, "Water - evacuation", "<h2 class = 'pan'>Water For Evacuation</h2><br><a href = '#'>Water bottles with purifying filters</a>. They are easy to pack. Also water bubblers are usually highly regulated, safe, clean sources of water. (Mobile apps such as Fountain Finder or WeTap can assist you in finding a bubbler nearby.\)   "],
    ["all", iFood, iHome, "Non-perishable food - home","<h2 class = 'pan'>Food For Your Home</h2><br>There are more options for non-perishable food for your home shelter than the food you store in case of evacuation, especially if you have a <a href = '#'>deep-freezer</a>. Even if you lose power, <a href = '#'>frozen foods</a> will be good for several days.  In an evacuation, the weight of your 'kit' is far more important than it is for a 'shelter in-place'. Canned goods are choices.  Remember to to stock food that does not need to be cooked, in case you lose that power."],
    ["all", iFood, iCar, "Non-perishable food - evacuation", "<h2 class = 'pan'>Food For Evacuation</h2><br>nonperishable food"],
    ["all", iMedkit, iPerson, "Medications and Rx's", "<h2 class = 'pan'>Medications and Rx's</h2><br>A list of the medications each member of your household takes_ why they take them_ and their dosages. If you store extra medication in your Go Bag, be sure to refill it before it expires. Get prescription preparedness tips from the LA Department of Health & Mental Hygiene"],
    ["all", iMedkit, iHome, "First aid kit", "<h2 class = 'pan'>First-aid kit</h2><br>"],
    ["all", iMoney, iHome, "Cash (in small bills)", "<h2 class = 'pan'>Cash</h2><br>"],
/*  
