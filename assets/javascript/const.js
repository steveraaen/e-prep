...
var nyc = [
    ...
    ["all", iFood, iHome, "Non-perishable food - home","<h2 class = 'pan'>Food For Your Home</h2><br>There are more options for non-perishable food for your home shelter than the food you store in case of evacuation, especially if you have a deep-freezer. Even if you lose power, frozen foods will be good for several days.  In an evacuation, the weight of your 'kit' is far more important than it is for a 'shelter in-place. Canned goods are choices.  Remember to to stock food that does not need to be cooked, in case you lose that power."],
    ["all", iFood, iCar, "Non-perishable food - evacuation", "<h2 class = 'pan'>Food For Evacuation</h2><br>nonperishable food"],
    ["all", iMedkit, iPerson, "Medications and Rx's", "<h2 class = 'pan'>Medications and Rx's</h2><br>A list of the medications each member of your household takes_ why they take them_ and their dosages. If you store extra medication in your Go Bag_ be sure to refill it before it expires. Get prescription preparedness tips from the LA Department of Health & Mental Hygiene"],
